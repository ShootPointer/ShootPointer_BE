...
public class FcmCommandController {
	...
	@Operation(
		...
		responses = {
			...
			@ApiResponse(responseCode = "4XX", description = "FCM 토큰 등록 실패", content = @Content(mediaType = "application/json"))
		}
	)
	...
	@Operation(
		...
		responses = {
			...
			@ApiResponse(responseCode = "4xx", description = "알림 전송 실패", content = @Content(mediaType = "application/json"))
		}
	)
	@PostMapping("/send")
