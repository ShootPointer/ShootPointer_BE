           ...
           stage('Generate Nginx Config') {
            steps {
                ...
                server {
                    listen 443 ssl;
                    listen [::]:443 ssl;
                    server_name tkv00.ddns.net;

                    ssl_certificate     /etc/letsencrypt/live/tkv00.ddns.net/fullchain.pem;
                    ssl_certificate_key /etc/letsencrypt/live/tkv00.ddns.net/privkey.pem;
                    ssl_protocols       TLSv1.2 TLSv1.3;
                    ssl_ciphers         HIGH:!aNULL:!MD5;

                    location / {
                        proxy_pass http://shootpointer:9000;
